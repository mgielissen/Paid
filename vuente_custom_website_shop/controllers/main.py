...
class VuenteWebsiteSale(openerp.addons.website_sale.controllers.main.website_sale):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        top_products_ids = product_obj.search(cr, uid, [], order="sales_count desc", context=context, limit=5)
        top_products = product_obj.browse(cr, uid, top_products_ids, context=context)
